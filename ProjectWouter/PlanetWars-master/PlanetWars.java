...
public class PlanetWars {
    ...
    public List<Planet> getAttackedPlanets(){
    	return attackedPlanets;
    }
    
    public Planet getLastNeutralAttackedPlanet(){
    	for(int i=attackedPlanets.size()-1; i <= 0; i--){
    		if(attackedPlanets.get(i).Owner() == 0){
    			return attackedPlanets.get(i);
    		}
    	}
    	return null;
    }
