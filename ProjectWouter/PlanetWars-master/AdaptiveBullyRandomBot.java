...
public class AdaptiveBullyRandomBot {
	...
	public static void DoBullyBotTurn(PlanetWars pw) {
		...
		//(1)Select my strongest planet to send ships from
		...
		//(2)Select strongest enemy planet
	...
	public static void DoRandomBotTurn(PlanetWars pw) {
		...
		//(1) Find the planets we can conquer
	...
	static List<Planet> conquerablePlanets(List<Planet> NotMyPlanets, int force){
