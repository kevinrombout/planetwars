...
public class MinMaxBot {
	...
	static double scoreExtraZetten(SimulatedPlanetWars simpw, int NumbTurns){
	...
	static double zettenSpelen(SimulatedPlanetWars simpw, Planet myPlanet, Planet notMyPlanet){
		...
		// (8) simulate the opponent's turn, assuming that the opponent is the BullyBot		
		 ...
		 */
		static MinMaxBot dummyBot = new MinMaxBot();
